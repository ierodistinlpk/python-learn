...
class ExpenceGroupedSerializer(serializers.ModelSerializer):
    class Meta:
        model = Expence
        exclude = ('logtime','user_id')


#Expence.objects.values('exptime','category').annotate(catdate=models.Sum('summ', output_field=FloatField()))
